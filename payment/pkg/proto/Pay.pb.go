...
type PayNotify struct {
	...
	GiftBoxId     *int32                 `protobuf:"varint,7,opt,name=giftBoxId" json:"giftBoxId,omitempty"`       // 礼包ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PayNotify) GetGiftBoxId() int32 {
	if x != nil && x.GiftBoxId != nil {
		return *x.GiftBoxId
	}
	return 0
}
...
const file_pkg_proto_Pay_proto_rawDesc = "" +
	...
	"\x03msg\x18\x03 \x01(\tR\x03msg\"\xe5\x02\n" +
	"\tPayNotify\x12\x18\n" +
	...
	"expireTime\x12\"\n" +
	"\fpurchaseTime\x18\x06 \x02(\x03R\fpurchaseTime\x12\x1c\n" +
	"\tgiftBoxId\x18\a \x01(\x05R\tgiftBoxId\x1a\x83\x01\n" +
	"\x03Ret\x12\x18\n" +
